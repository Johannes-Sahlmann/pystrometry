...
PACKAGENAME = metadata.get('package_name', 'pystrometry')
DESCRIPTION = metadata.get('description', 'Support for astrometry timeseries analysis')
AUTHOR = metadata.get('author', 'Johannes Sahlmann')
...
if sys.version_info < tuple((int(val) for val in __minimum_python_version__.split('.'))):
    sys.stderr.write("ERROR: pystrometry requires Python {} or later\n".format(__minimum_python_version__))
    sys.exit(1)
